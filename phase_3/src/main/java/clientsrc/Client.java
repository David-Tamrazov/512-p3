...
public class Client {
    ...
    public static void main(String args[])
    {
        ...
        while (true) {
            ...
            case 24: //commit
            	try {
            		if(mws.commit(obj.getInt(arguments.elementAt(1)))) {
	            		System.out.println("Transaction " + obj.getString(arguments.elementAt(1)) +  " committed");
	            	} else {
            ...
            case 25: //abort
            	try {
	            	mws.abort(obj.getInt(arguments.elementAt(1)));
	            	System.out.println("Transaction " + obj.getString(arguments.elementAt(1)) + " aborted");
            	} catch (DeadlockException d) {
	            	System.out.println("Deadlock");
            	} catch (Exception e) {
	            	System.out.println("EXCEPTION:");
